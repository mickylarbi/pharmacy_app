          ...
          children: [
            ...
            Row(
              children: [
                ...
                IconButton(
                  onPressed: () {
                    if (int.tryParse(quantityInStockController.text.trim()) !=
                            null &&
            ...
            ElevatedButton(
              ...
              child: Text(widget.drug != null ? 'Save changes' : 'Add drug'),
              onPressed: () {
                Drug newDrug = Drug(
                ...
                if (newDrug == widget.drug) {
                  ...
                  showAlertDialog(context, message: 'Please enter a class');
                  ...
                  showAlertDialog(context, message: 'Enter a valid price');
                } else if (newDrug.quantityInStock == null) {
                  showAlertDialog(context, message: 'Enter a valid quantity');
                  ...
                  showAlertDialog(context, message: 'Please add a picture');
                } else {
                  showConfirmationDialog(
                    context,
                    ...
                    confirmFunction: () {
                      ...
                      if (widget.drug != null) {
                        db.updateDrug(newDrug).timeout(ktimeout).then((value) {
                          Navigator.pop(context);
                          Navigator.pop(context);
                        }).onError((error, stackTrace) {
                          Navigator.pop(context);
                        ...
                        db
                          ...
                          storage
                            ...
                            showLoadingDialog(context);
                            drugReference.get().timeout(ktimeout).then((value) {
                              Navigator.pop(context);
                              navigate(
                                  context,
  ...
  changePhotoWidget() {
    return StatefulBuilder(builder: (context, setState) {
      return FutureBuilder<String>(
        future: storage.drugImageDownloadUrl(widget.drug!.id!),
